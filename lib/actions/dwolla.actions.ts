...
// Create a Dwolla Funcding Source using a Plaid Processor Token
...
export const createTransfer = async ({
    ...
    try {
        ...
        console.error("Creating a Transfer Failed: ", err);
    }
};
...
export const addFundingSource = async ({
    ...
    try {
        ...
        // add funding souce to the dwolla customer & get the funding souce
